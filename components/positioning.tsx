...
export function Positioning() {
  return (
    <section id="explore" className="bg-white text-neutral-900">
      ...
      <div className="mx-auto max-w-[900px] border-t border-neutral-200 px-6 py-28 text-center md:py-36">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-neutral-500">
            We continuously invent software for the financial markets —
            transforming complexity into intelligent, institutional-grade
            solutions.
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-pretty text-lg font-medium leading-relaxed text-neutral-800">
